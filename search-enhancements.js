(function () {
  ...
  function makeReviewSection() {
    ...
    section.innerHTML = [
      ...
      '<p>Kurti Aura publishes feedback only from confirmed customers. No copied testimonials, no made-up ratings—just genuine experiences after delivery.</p>',
      '<span class="aura-review-pill">VERIFIED ORDERS ONLY</span>',
      '</div>',
      '<div class="aura-review-body">',
      '<div class="aura-review-standards">',
      '<article><span>01</span><small>CONFIRMED ORDER</small><h3>Reviews are verified</h3><p>We match feedback with a completed Kurti Aura order before it appears in the gallery.</p></article>',
  ...
  function enhanceCatalog() {
    ...
    input.setAttribute("aria-label", "Search all " + totalProducts + " Kurti Aura products");
